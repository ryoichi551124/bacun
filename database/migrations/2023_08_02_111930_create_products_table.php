...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->text('content1')->nullable()->comment('商品説明1');
            $table->text('content2')->nullable()->comment('商品説明2');
            $table->text('content3')->nullable()->comment('商品説明3');
            $table->text('content4')->nullable()->comment('商品説明4');
            $table->text('memo')->nullable()->comment('メモ');
            $table->unsignedSmallInteger('stock')->comment('在庫数');
            $table->enum('type', [1, 2])->comment('商品タイプ [1 => "一般商品", 2 => "ダウンロード商品"]');
            ...
            $table->foreignId('delivery_id')->nullable()->constrained()->comment('送料ID');
            $table->timestamps();
